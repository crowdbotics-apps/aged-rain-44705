"""
Django settings for aged_rain_44705 project.
...
ROOT_URLCONF = 'aged_rain_44705.urls'
...
WSGI_APPLICATION = 'aged_rain_44705.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_rain_44705 API",
    "DESCRIPTION": "API documentation for aged_rain_44705 App",
    "VERSION": "v1",
}
